...
Follow the [Agent Note rules](README.md) for layout, lifecycle, and writing. Notes preserve durable rationale, alternatives, consequences, and required verification.
